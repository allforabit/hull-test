(function() {
  ...
  define(['underscore', 'lib/utils/promises', 'aura/aura', 'lib/utils/handlebars', 'lib/hull.api', 'lib/utils/emitter', 'lib/client/component/registrar', 'lib/helpers/login', 'backbone'], function(_, promises, Aura, Handlebars, HullAPI, emitterInstance, componentRegistrar, loginHelpers) {
